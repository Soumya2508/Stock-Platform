...
class StockData(Base):
    ...
    # Composite and single indexes for query performance and data integrity
    __table_args__ = (
        Index('idx_unique_symbol_date', 'symbol', 'date', unique=True),
        Index('idx_symbol_date_lookup', 'symbol', 'date'),
        Index('idx_date', 'date'),
    )
